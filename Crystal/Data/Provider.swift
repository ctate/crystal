...
let providers = [
    ...
    Provider(id: "Ollama", name: "Ollama", image: "OllamaLogo", models: [
        ProviderModel(id: "gemma", name: "Gemma 7B", hasVision: false),
        ProviderModel(id: "llama3", name: "Llama 3 8B", hasVision: false),
        ProviderModel(id: "llama3:70b", name: "Llama 3 70B", hasVision: false),
        ProviderModel(id: "mixtral", name: "Mixtral 8x7B", hasVision: false)
    ]),
